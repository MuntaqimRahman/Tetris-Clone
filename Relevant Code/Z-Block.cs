...
namespace Tetris_Game
{
    class Z_Block : Tetrimino
    {
        ...
        public Z_Block() 
        {
            tetriminoBlock = Tetris_Game.Properties.Resources.z_block;
        ...
        public void findPoints()//Defines all other points based off center
        {
            ...
            points[0] = new Point(center.X - 36, center.Y - 36);
            points[1] = new Point(center.X - 12, center.Y - 36);
            points[2] = new Point(center.X - 12, center.Y - 12);
            points[3] = new Point(center.X + 12, center.Y - 12);
        }
    }
}
